...
public class McpFunctionMetadataTransformerTests
{
    ...
    public void Transform_MatchingBinding_NoToolPropertiesConfiguredAndNoAttributes_FallsBackEmpty()
    {
        ...
        Environment.SetEnvironmentVariable(FunctionsApplicationDirectoryKey, outputDir);
            ...
            var promptOptions = new Mock<IOptionsMonitor<PromptOptions>>(); promptOptions.Setup(o => o.Get(It.IsAny<string>())).Returns(new PromptOptions()); var transformer = new McpFunctionMetadataTransformer(options.Object, resourceOptions.Object, promptOptions.Object, NullLogger<McpFunctionMetadataTransformer>.Instance);
    ...
    private static McpFunctionMetadataTransformer CreateTransformer(List<ToolProperty>? configured = null)
    {
        ...
        var resourceOptions = new Mock<IOptionsMonitor<ResourceOptions>>();
        resourceOptions.Setup(o => o.Get(It.IsAny<string>())).Returns(new ResourceOptions());
        var promptOptions = new Mock<IOptionsMonitor<PromptOptions>>(); promptOptions.Setup(o => o.Get(It.IsAny<string>())).Returns(new PromptOptions()); return new McpFunctionMetadataTransformer(options.Object, resourceOptions.Object, promptOptions.Object, NullLogger<McpFunctionMetadataTransformer>.Instance);
    }
