...
public class AddMetadataExtensionTests
{
    ...
    public void AddMetadata_FluentMetadataAppliedToToolTrigger()
    {
        ...
        builder.AddMetadata(toolOptions, CreateResourceOptions());
    ...
    public void AddMetadata_FluentMetadataAppliedToResourceTrigger()
    {
        ...
        builder.AddMetadata(CreateToolOptions(), resourceOptions);
    ...
    public void AddMetadata_SkipsToolPropertyBindings()
    {
        ...
        builder.AddMetadata(CreateToolOptions(), CreateResourceOptions());
    ...
    public void AddMetadata_ReturnsSameBuilder_ForChaining()
    {
        ...
        var result = builder.AddMetadata(CreateToolOptions(), CreateResourceOptions());
