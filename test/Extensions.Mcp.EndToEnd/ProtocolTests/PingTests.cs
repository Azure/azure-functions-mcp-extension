...
{
    public class PingTests : IClassFixture<DefaultProjectFixture>
    {

        private readonly DefaultProjectFixture _fixture;
        public PingTests(DefaultProjectFixture fixture, ITestOutputHelper testOutputHelper)
        {
            _fixture = fixture;
        ...
        public async Task ServerRespondsToClientPing(HttpTransportMode mode)
        {
        ...
        [Theory]
        [InlineData(HttpTransportMode.Sse)]
        public async Task ServerSendsPingsWithinSixMinutes(HttpTransportMode mode)
        {
