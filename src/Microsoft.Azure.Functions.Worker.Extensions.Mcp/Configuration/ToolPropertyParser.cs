...
internal static class ToolPropertyParser
{
    ...
    /// </summary>
    public static bool TryGetPropertiesFromAttributes(IFunctionMetadata functionMetadata, IFunctionMethodResolver functionMethodResolver, out List<ToolProperty>? toolProperties)
    {
